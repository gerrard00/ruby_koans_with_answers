...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Equivalent to Javascript reduce; iterates over an iterable calling a function with the current collected value
    # (or the seed value on the iteration). The collected value is set to the return value of the function
  end
  ...
  #
  # To ensure that the file was closed as soon as the related code was complete
end
